...
¿Y si, en la transmisión de datos, se corrompen dos bits?  Entonces, el sistema podría ser insuficiente. Pero piensa en este sencillo ejemplo: De una memoria lees al ritmo de un dato cada 10 nanosegundos, y la probabilidad de leer un bit erróneo es de 1 cada 100 millones. La probabilidad de que un mismo dato tenga dos errores es de aproximadamente 1 cada 3 años de funcionamiento continuo. ¡Prácticamente despreciable!

Hay sistemas, imagina el control de vuelo de un avión, dónde esto no es admisible. En estos casos se suelen combinar mas bits de paridad, como usa el código [Hamming](https://harryli0088.github.io/hamming-code/) o [Reed-Solomon](https://en.wikipedia.org/wiki/Reed%E2%80%93Solomon_error_correction).
